    ...
    <nav class="navbar navbar-static-top pl-30">
      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
          ...
          <!-- User Account-->
          <li class="dropdown user user-menu"> @if (Laravel\Jetstream\Jetstream::managesProfilePhotos()) <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0 lex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition" data-toggle="dropdown" title="{{ Auth::user()->name }}">
              <img class="h-8 w-8 rounded-full object-cover" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
            </a> @else <span class="inline-flex rounded-md">
            ...
            </span> @endif <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
